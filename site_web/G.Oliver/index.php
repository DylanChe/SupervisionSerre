...
<div id="page" class="hfeed site">
                            ...
                            <nav class="navbar navbar-default row" role="navigation">
                                ...
                                <div class="collapse navbar-collapse navbar-ex-collapse">
                                    <ul id="menu-menu-principale" class="nav navbar-nav">
                                        <li id="menu-item-2" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1 dropdown">
											<a title="etat_serre" href="etat_serre.html">Etat de la serre</a>
                                        </li>
                                        <li id="menu-item-3" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-2 dropdown">
    ...
    <div class="slideshow hidden-xs"><style type='text/css'>
        #accueilpjc-slideshow .frs-timer { display: none !important; }




        #accueilpjc .frs-wrapper .frs-caption {
            display:none;
        }
        #accueilpjc-slideshow .frs-caption h2, #accueilpjc-slideshow .frs-caption-inner h2{
            font-size:22px;
            margin:0px;
        }
        #accueilpjc-slideshow .frs-caption p, #accueilpjc-slideshow .frs-caption-inner p{
            margin:0px;
            font-size:16px;
        }
        ...
        .frs-caption-content div h1, .frs-caption-content div h2, .frs-caption-content div h3, .frs-caption-content div h2, .frs-caption-content div p {
            color: inherit !important;
            text-align: inherit !important;
            line-height: 1.5;
        }

    </style><link rel='stylesheet' href='http://www.groupe-olivier.fr/wp-content/plugins/fluid-responsive-slideshow/buttons/frs-buttonskin-white.css' type='text/css'><style>.frs-slideshow-container#accueilpjc {
        margin-bottom:30px;
        margin-top: 0px;
    }
    </style><!-- Slideshow generated using Fluid-Responsive-Slideshow, http://www.tonjoo.com/addons/fluid-responsive-slideshow/ -->
        <script type='text/javascript'>
            jQuery(document).ready(function($) {
                jQuery('#accueilpjc').frs({
                 ...
                 * touchSwipe
                 */
                jQuery('#accueilpjc-slideshow .frs-slide-img').swipe(
                    {
                        swipeLeft:function(event, direction, distance, duration, fingerCount) {
                            $('#accueilpjc-slideshow .frs-slider-nav .frs-arrow-right').click();
                        },

                        swipeRight:function(event, direction, distance, duration, fingerCount) {
                            $('#accueilpjc-slideshow .frs-slider-nav .frs-arrow-left').click();
                        },
        ...
        <style type='text/css'>
            #accueilpjc-slideshow .frs-timer { display: none !important; }
            #accueilpjc-slideshow div.caption { background:transparent; filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000,endColorstr=#99000000);zoom: 1; }
        </style>
        <![endif]-->
		<div class='frs-slideshow-container' id='accueilpjc'>
			<div class='frs-slide-img-wrapper' style='display:none;'>
				<div class='frs-slide-img' style = 'display:none;background:#ffffff' >
					<img src='inc/img/banner_supervision1.jpg' />
					<div class='frs-caption frs-caption-position-bottom-right' style='display: block;' id='captionaccueilpjc'>
						<div class='frs-caption-outer' style='height:100%;width:100%;display:table;'>
							<div class='frs-caption-inner' style='text-align:left; height:100%;display:table-cell;'>
								<div class='frs-caption-content' style='width: 41.666666666667%; background: url("inc/img/blue.png") repeat scroll 0% 0% transparent !important; padding:25px;'>
								<h2 style='text-align:left; color:#ffffff;'>Une supervision simple d'accès</h2>
				...
				<div class='frs-slide-img' style = 'display:none;background:#ffffff' >
					<img src='inc/img/banner_supervision2.jpg'/>
					<div class='frs-caption frs-caption-position-bottom-right' style='display: block;' id='captionaccueilpjc'>
						<div class='frs-caption-outer' style='height:100%;width:100%;display:table;'>
							<div class='frs-caption-inner' style='text-align:left; height:100%;display:table-cell;'>
								<div class='frs-caption-content' style='width: 41.666666666667%; background: url("inc/img/blue.png") repeat scroll 0% 0% transparent !important; padding:25px;'>
									<h2 style='text-align:left; color:#ffffff;'>Accessible en un clic</h2>
										<div style='text-align:left; color:#ffffff;'>
										</div>
								</div>
							</div>
				...
				<div class='frs-slide-img' style = 'display:none;background:#ffffff' >
					<img src='inc/img/banner_supervision3.jpg' />
					<div class='frs-caption frs-caption-position-bottom-right' style='display: block;' id='captionaccueilpjc'>
						<div class='frs-caption-outer' style='height:100%;width:100%;display:table;'>
							<div class='frs-caption-inner' style='text-align:left; height:100%;display:table-cell;'>
								<div class='frs-caption-content' style='width: 41.666666666667%; background: url("inc/img/blue.png") repeat scroll 0% 0% transparent !important; padding:25px;'>
									<h2 style='text-align:left; color:#ffffff;'>Uniquement dans vos locaux</h2>
										<div style='text-align:left; color:#ffffff;'>
										</div>
								</div>
							</div>
    ...
    <!-- ----------------- -->
        ...
        <div class="container">
            <div class="home-widget-area row">
                ...
                <div class="col-sm-6">
							<a href="etat_serre.html" class="center-block">
							<center><img style="border: 0 none;" src="inc/img/etat.png" alt="" width="150" height="150" />
							<br>
							<span style="font-family: 'Nothing You Could Do'; font-size: 150%">Etat de la serre</span></center>
							</a>
				</div>

                <div class="col-sm-6 col-md-6 home-widget">
                    <div id="text-7" class="widget widget_text">
							<a href="evolution_mesure.html" class="center-block">
							<center><img style="border: 0 none;" src="inc/img/courbe.png" alt="" width="150" height="150" />
							<br>
							<span style="font-family: 'Nothing You Could Do'; font-size: 150%">Visualisation des mesures</span></center>
							</a>
                    </div>            
				</div>
            </div>
